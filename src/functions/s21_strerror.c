...
#define MIN_ERR_NUM -1
#define MAX_ERR_NUM 134
#define STR_ERR "Unknown error %d"
 ...
 * @return char* указатель на строку с сообщением об ошибке под номером errnum
 */
char *s21_strerror(int errnum) {
  char *error = s21_NULL;
  static char str[100] = {0};
  if (errnum > MIN_ERR_NUM && errnum < MAX_ERR_NUM) {
    error = (char *)error_list[errnum];
  } else {
    s21_sprintf(str, STR_ERR, errnum);
    error = str;
  }
  return error;
}
